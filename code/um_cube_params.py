...
'gh': {
       ...
       'extract_level_before_diag': True,
       'plt_method': 'contour',
       'plt_kw': dict(colors='#fe019a', levels=np.arange(0, 10000, 20), linewidths=0.75),
       'clabels': dict(inline=1, fmt='%1.0f', fontsize=12, colors='#fe019a'),
#       'scl': 1e-1,
...
'SSTmT': {
           ...
           'diag_method': 'SSTmT',
           'plt_method': 'contour',
           'plt_kw': dict(levels=[43, 50], colors='#0cff0c', linestyles=['-'], linewidths=1.5),
           'clabels': dict(inline=1, fmt='%1.0f', fontsize=12),
